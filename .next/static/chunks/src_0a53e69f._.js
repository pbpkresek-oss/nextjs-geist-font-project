    ...
    try {
            ...
            const defaultCategories = [
                {
                    ...
                    description: 'Alat-alat medis dan kesehatan'
                },
                {
                    name: 'Furniture',
                    description: 'Meja, kursi, lemari, dan furniture lainnya'
                },
                {
                    name: 'Elektronik',
                    description: 'Komputer, printer, dan peralatan elektronik'
                },
                {
                    name: 'Kendaraan',
                    description: 'Ambulans dan kendaraan operasional'
                },
                {
                    name: 'Obat-obatan',
                    description: 'Persediaan obat dan farmasi'
                }
            ];
        ...
        if (users.length === 0) {
            const defaultUsers = [
                {
                    name: 'Administrator',
                    email: 'admin@puskesmaskresek.id',
                    role: 'Admin'
                },
                {
                    name: 'Staff Inventaris',
                    email: 'staff@puskesmaskresek.id',
                    role: 'Staff'
                }
            ];
...
function UsersPage() {
    ...
    const loadUsers = ()=>{
        try {
            const usersData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUsers"])();
            setUsers(usersData);
        } catch (error) {
    ...
    const validateForm = ()=>{
        ...
        if (!formData.name.trim()) {
            newErrors.name = 'Nama pengguna harus diisi';
        }
        if (!formData.email.trim()) {
            newErrors.email = 'Email pengguna harus diisi';
        } else if (!/\S+@\S+\.\S+/.test(formData.email)) {
            newErrors.email = 'Format email tidak valid';
        } else if (users.some((user)=>user.email.toLowerCase() === formData.email.toLowerCase().trim() && user.id !== editingUser?.id)) {
    ...
    const handleSubmit = (e)=>{
        ...
        try {
            if (editingUser) {
                ...
                const updatedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"])(editingUser.id, {
                ...
                if (updatedUser) {
                    ...
                    showAlert('error', 'Gagal memperbarui pengguna');
                }
            } else {
                // Add new user
                const newUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addUser"])({
                    name: formData.name.trim(),
                    email: formData.email.trim(),
                    role: formData.role
                });
    ...
    const handleDelete = (id)=>{
        ...
        try {
            const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteUser"])(id);
            if (success) {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Kelola pengguna yang memiliki akses ke sistem"
                        }, void 0, false, {
                            fileName: "[project]/src/app/users/page.tsx",
                            lineNumber: 161,
                            columnNumber: 11
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                            children: isEditing ? 'Edit Pengguna' : 'Tambah Pengguna Baru'
                        }, void 0, false, {
                            fileName: "[project]/src/app/users/page.tsx",
                            lineNumber: 170,
                            columnNumber: 11
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            type: "submit",
                                            children: isEditing ? 'Perbarui Pengguna' : 'Tambah Pengguna'
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/users/page.tsx",
                                            lineNumber: 234,
                                            columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: users.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm",
                                    children: "Mulai dengan menambahkan pengguna pertama Anda"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/users/page.tsx",
                                    lineNumber: 258,
                                    columnNumber: 15
...
_s(UsersPage, "+4KPIvevPXen1YRsdVS5IwC9WzA=");
_c = UsersPage;
var _c;
...
//# sourceMappingURL=src_0a53e69f._.js.map